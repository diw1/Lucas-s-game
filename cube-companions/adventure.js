export const regions=[
 {id:'grove',name:'Home Grove',x:0,z:3.5,colors:['#81ab68','#7ba562'],foliage:'#548650',species:['sprig','brawl','venom','jab','puff','grub','sky']},
 {id:'volcano',name:'Ember Volcano',x:30,z:0,colors:['#765854','#825d51'],foliage:'#dd7044',species:['ember','pebble','dune','drake']},
 {id:'lake',name:'Crystal Lake',x:0,z:30,colors:['#7fc3cb','#8bd2d1'],foliage:'#499f9e',species:['bubble','sprig','mire','otter','frost','volt']},
 {id:'mine',name:'Iron Mountains',x:-30,z:0,colors:['#9093a5','#a4a5b3'],foliage:'#b4c9e2',species:['steel','pebble','brawl','dune','volt','drake']},
 {id:'fairy',name:'Starlight Forest',x:0,z:-30,colors:['#b995bf','#ab8dbb'],foliage:'#df9acc',species:['fairy','sprig','venom','prism','wisp','shade']}
];
